...
public class Bezier : MonoBehaviour
{
        ...
        public static Vector3 EvaluateQuadraticFunc(Vector3 A, Vector3 B, Vector3 C, float t)
        {
            return A * (t * t - 2 * t + 1) +
                   B * (2 - t - 2 * t * t) +
                   C * (t * t);
        ...
        public static Vector3 EvaluteQubicFunc(Vector3 A, Vector3 B, Vector3 C, Vector3 D, float t)
        {
